...
docker run -d --rm --user $(id -u):$(id -g) -v /home/dantunes/chip_seq/results:/data/ quay.io/biocontainers/macs2:2.1.2--py27r351h14c3975_1 bash -c 'macs2 \
callpeak -t counts_T_SRR3737445.fastq.gz.sam'
